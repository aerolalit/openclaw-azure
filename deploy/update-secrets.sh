...
AZURE_STORAGE_ACCOUNT_NAME=AZURE_STORAGE_ACCOUNT_NAME_PLACEHOLDER
AZURE_STORAGE_ACCOUNT_KEY=AZURE_STORAGE_ACCOUNT_KEY_PLACEHOLDER
...
# Get storage account name and key (preserve existing values)
print_status "Getting storage account credentials..."
...
UPDATE_SCRIPT="${UPDATE_SCRIPT//AZURE_STORAGE_ACCOUNT_NAME_PLACEHOLDER/$STORAGE_ACCOUNT}"
UPDATE_SCRIPT="${UPDATE_SCRIPT//AZURE_STORAGE_ACCOUNT_KEY_PLACEHOLDER/$STORAGE_KEY}"
