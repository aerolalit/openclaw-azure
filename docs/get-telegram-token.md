...
Your OpenClaw can connect to Telegram instead of (or in addition to) Discord. Here's how to create a Telegram bot and get its token:
...
⚠️ **Keep your token secret!** Anyone with this token can control your bot. Never share it publicly.

## What's Next?

1. **Copy your token** and save it somewhere safe
2. Use it in the **"Telegram Bot Token"** field when deploying OpenClaw
3. Leave the Discord token field empty if you only want Telegram

## Telegram vs Discord

**Telegram Advantages:**
- ✅ Easier setup (no developer portal)
- ✅ Works on all devices instantly
- ✅ Better for personal use
- ✅ No server permissions to manage

**Discord Advantages:**
- ✅ Better for gaming communities
- ✅ Rich server organization features
- ✅ Voice channels
- ✅ Better for large communities

---

**Need help?** Check our [troubleshooting guide](troubleshooting.md) or [open a GitHub issue](https://github.com/aerolalit/openclaw-azure/issues).